...
using System.Windows.Forms;
    ...
    namespace MyXButton
    {
        public partial class XButton : Button
        {
            ...
            private MyXButton.Theme thm = MyXButton.Theme.MSOffice2010_BLUE;
            ...
            protected override void OnPaint(PaintEventArgs e)
            {
                ...
                if (thm == MyXButton.Theme.MSOffice2010_BLUE || thm == MyXButton.Theme.MSOffice2010_Green || thm == MyXButton.Theme.MSOffice2010_Yellow || thm == MyXButton.Theme.MSOffice2010_Publisher ||
                    thm == MyXButton.Theme.MSOffice2010_RED || thm == MyXButton.Theme.MSOffice2010_WHITE || thm == MyXButton.Theme.MSOffice2010_Pink)
                {
            ...
            public MyXButton.Theme Theme
            {
                get
                {
                    if (this.colorTable == Colortable.Office2010Green)
                    {
                        return MyXButton.Theme.MSOffice2010_Green;
                    }
                    else if (this.colorTable == Colortable.Office2010Red)
                    {
                        return MyXButton.Theme.MSOffice2010_RED;
                    }
                    else if (this.colorTable == Colortable.Office2010Pink)
                    {
                        return MyXButton.Theme.MSOffice2010_Pink;
                    }
                    else if (this.colorTable == Colortable.Office2010Yellow)
                    {
                        return MyXButton.Theme.MSOffice2010_Yellow;
                    }
                    else if (this.colorTable == Colortable.Office2010White)
                    {
                        return MyXButton.Theme.MSOffice2010_WHITE;
                    }
                    else if (this.colorTable == Colortable.Office2010Publisher)
                    {
                        return MyXButton.Theme.MSOffice2010_Publisher;
                    }

                    return MyXButton.Theme.MSOffice2010_BLUE;
                }
                ...
                set
                {
                    ...
                    if (thm == MyXButton.Theme.MSOffice2010_Green)
                    {
                        this.colorTable = Colortable.Office2010Green;
                    }
                    else if (thm == MyXButton.Theme.MSOffice2010_RED)
                    {
                        this.colorTable = Colortable.Office2010Red;
                    }
                    else if (thm == MyXButton.Theme.MSOffice2010_Pink)
                    {
                        this.colorTable = Colortable.Office2010Pink;
                    }
                    else if (thm == MyXButton.Theme.MSOffice2010_WHITE)
                    {
                        this.colorTable = Colortable.Office2010White;
                    }
                    else if (thm == MyXButton.Theme.MSOffice2010_Yellow)
                    {
                        this.colorTable = Colortable.Office2010Yellow;
                    }
                    else if (thm == MyXButton.Theme.MSOffice2010_Publisher)
                    {
